      ...
      <nav className="bg-black h-[80px] px-4 text-white flex flex-row-reverse md:flex-row justify-between items-center 2xl:w-[1280px] mx-auto">
        ...
        <div>
          <ul className={`lg:static absolute left-0 bg-black lg:min-h-fit min-w-full flex flex-col lg:flex-row lg:justify-center px-3 lg:px-0 ${show ? "top-[100%]  min-h-[35vh]": "top-[-400%]"} transition-all duration-500 lg:items-center lg:z-0 gap-6 z-[-1]`}>
            <NavLink onClick={handleClick} to="/" className="navLink">Home</NavLink>
            <NavLink onClick={handleClick} to="aboutUs" className="navLink">About Us</NavLink>
            <NavLink onClick={handleClick} to="team" className="navLink">Team</NavLink>
            <NavLink onClick={handleClick} to="portfolio" className="navLink">Portfolio</NavLink>
            <NavLink onClick={handleClick} to="services" className="navLink">Services</NavLink>
            <NavLink onClick={handleClick} to="projectBid" className="navLink">Project Bid</NavLink>
            <NavLink onClick={handleClick} to="blog" className="navLink">Blog</NavLink>
          </ul>
        </div>
